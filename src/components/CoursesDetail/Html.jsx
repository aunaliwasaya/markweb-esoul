...
<div className='container mx-auto'>
    ...
    <img className='md:w-[65%] w-[90%] ' src="https://websitedemos.net/online-coding-course-02/wp-content/uploads/sites/713/2020/10/online-coding-course-html-5-lesson-cover-img.jpg" alt="" />
      </div>


<div className='container md:w-[65%] w-[90%] mx-auto my-5'>

<p className='text-3xl font-normal'>HTML 5 Web Component Fundamentals</p>
<p className='text-3xl font-semibold py-4'>Course Description</p>
<p className='leading-8 text-[18px] font-normal text-gray-500 pr-12'>Eu adipiscing nec erat amet at aliquam blandit gravida massa suscipit massa fames nibh dapibus tristique dolor a cursus maecenas praesent elit donec faucibus eget commodo ultricies amet molestie nunc sit sed enim magna et viverra purus blandit amet a cursus elementum ipsum sit accumsan blandit pretium vitae mollis sociis mauris nulla varius bibendum fames facilisis elit, donec et ultrices neque mauris, aenean morbi.</p>
...
<div className='flex align-middle justify-self-start border-2 border-gray-200 rounded-md p-4'>
       ...
       <a href="https://websitedemos.net/online-coding-course-02/lessons/install-and-setup/" className='px-4  text-xl font-normal text-gray-600  hover:text-blue-400'>HTML 5 Introduction</a>
        </div>


        <div className='flex align-middle justify-self-start border-2 border-gray-200 rounded-md p-4 my-4 '>
       <p className='pl-3 py-1 text-gray-300 text-2xl font-bold'><FaRegCircle /> </p>
       <a href="https://websitedemos.net/online-coding-course-02/lessons/python-basic/" className='px-4  text-xl font-normal text-gray-600 hover:text-blue-400'>HTML 5 Basic</a>
        </div>


        <div className='flex align-middle justify-self-start border-2 border-gray-200 rounded-md p-4 '>
       <p className='pl-3 py-1 text-gray-300 text-2xl font-bold'><FaRegCircle /> </p>
       <a href="https://websitedemos.net/online-coding-course-02/lessons/python-advanced/" className='px-4  text-xl font-normal text-gray-600  hover:text-blue-400'>HTML 5 Advance</a>
        </div>
