...
<div className='container  pt-8  pb-5 flex justify-between '>
        <img
          ...
          <Link to="/pythonBasic" className='text-blue-500 hover:text-blue-400 font-bold cursor-pointer md:pr-6 ml-60'>Next Lesson       
           </Link>
     ...
     <h1 className="md:text-5xl text-3xl text-balance  font-bold pt-2 pb-5 ">Python Advance</h1>
 ...
 <p  className='text-blue-500 hover:text-blue-400 font-bold cursor-pointer text-xs'>Python Advance</p>
</div>
...
<Link to="/course" className='text-blue-500 hover:text-blue-400 font-medium cursor-pointer text-md md:ml-64 pt-2 '>Back to Course       
 ...
 <Link to="/pythonBasic"  className='text-white  font-bold cursor-pointer text-sm px-3'>Next Lesson</Link>
