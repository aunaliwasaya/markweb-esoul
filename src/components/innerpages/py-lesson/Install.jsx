...
<div className='container  pt-8  pb-5 flex justify-between '>
      ...
      <div className='flex-1 py-8 lg:ml-48'>
    

   

     <div className=' flex-1 flex-col justify-center md:w-[70%] md:ml-10 ml-0 '>
     <h1 className="md:text-5xl text-3xl text-balance  font-bold pt-2 pb-5 ">Install and Setup</h1>
...
<Link to="/course" className='text-blue-500 hover:text-blue-400 font-medium cursor-pointer text-md md:ml-64 pt-2 '>Back to Course       
 ...
 <Link to="/pythonAdv"  className='text-white  font-bold cursor-pointer text-sm px-3'>Next Lesson</Link>
